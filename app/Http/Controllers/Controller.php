...
class Controller extends BaseController
{
    ...
    protected $deleteForbiddenRoles;
    protected $deleteForbiddenUsers;
    ...
    function __construct()
    {
        ...
        $adminId = User::where('email','admin@elorrieta-errekamari.com')->pluck('id')->first();

        $this->deleteForbiddenRoles = [$studentRoleId,$teacherRoleId,$adminRoleId];
        $this->deleteForbiddenUsers = [$adminId];
    }
    ...
    public function checkIfDeleteForbiddenUser(User $user){
        if (in_array($user->id,$this->deleteForbiddenUsers)) {
            return true;
        } else {
            return false;
        }

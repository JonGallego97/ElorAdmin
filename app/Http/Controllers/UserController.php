...
class UserController extends Controller
{
    ...
    {
        //Comprueba que haya metido minimo un rol
        ...
        // while ($loop) {
        //     $checkEmail = User::select('email')->where('email',$user->email)->get();
        //     if ($checkEmail != null) {
        //         $user->email = $userName . rand(10,99) . $domainName;
        //     } else {
        //         $loop = false;
        //     }
        // }
